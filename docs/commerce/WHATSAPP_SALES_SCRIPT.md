...
• 30 captions/outlines ready to post
• Weekly posting rhythm
• 25 hooks for your niche
• 1 revision pass within 7 days

Price: ₦22,000
Delivery: within 5 days after I receive your short brief
Guarantee: if it’s not delivered in 5 days, full refund

If that works for you, I’ll send the Paystack link.
...
1) Brand / page name
2) Niche + who you post for
3) Platforms (FB, IG, TikTok, X, etc.)
4) Tone (casual / formal / community)
5) 2–3 sample posts or a page link (optional)
...
I deliver the system: calendar, captions, hooks, and a weekly plan.
...
Send your brief now (copy & fill):

Brand/page:
Niche + audience:
Platforms:
Tone:
Samples/link (optional):
